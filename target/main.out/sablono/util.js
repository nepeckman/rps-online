...
var len__7622__auto___9932 = arguments.length;
var i__7623__auto___9933 = (0);
while(true){
if((i__7623__auto___9933 < len__7622__auto___9932)){
args__7629__auto__.push((arguments[i__7623__auto___9933]));

var G__9934 = (i__7623__auto___9933 + (1));
i__7623__auto___9933 = G__9934;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq9931){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9931));
});
/**
...
var vec__9936 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__9936,(0),null);
var words = cljs.core.nthnext.call(null,vec__9936,(1));
...
var G__9938 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__9938,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__9938;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__9939_SHARP_){
if(typeof p1__9939_SHARP_ === 'string'){
return p1__9939_SHARP_;
} else {
return cljs.core.seq.call(null,p1__9939_SHARP_);
